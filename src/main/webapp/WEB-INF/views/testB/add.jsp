	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false" data-widget-deletebutton="false"  >
				...
				<header>
					<h2>
						<strong><i class="fa fa-th-large"></i>&nbsp;添加测试B</strong>
					</h2>
				</header>
					     ...
					     <fieldset>
									...
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="关联TestA主键id" id="userId" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="家庭住址" id="address" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="联系电话" id="phoneNum" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="年龄" id="age" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="性别" id="sex" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="所在省" id="province" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="所在市" id="city" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="所在县" id="country" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
								<section>
									<div class="row">
										...
										<div class="col col-8">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input type="text" placeholder="删除标记位" id="flag" class="validate[required,maxSize[100]]" >
											</label>
										</div>
									</div>
								</section>
...
<script type="text/javascript">
	$(function() {
		//必须写	
		pageSetUp();
		showribbon("测试B管理,添加测试B");
		jQuery("#add-form").validationEngine('attach', {
		...
		if (flag1) {
			...
			success : function(data) {
				if (data.result + "" == "true") {
					$.smallBox({
						title : "消息",
						content : "<i class='fa fa-clock-o'></i> <i>添加成功,添加框即将关闭！</i>",
						color : "#659265",
					...
					$.smallBox({
						title : "消息",
						content : "<i class='fa fa-clock-o'></i> <i>添加失败，请稍后重试！</i>",
						color : "#c7254e",
						iconSmall : "fa fa-times fa-2x fadeInRight animated",
						timeout : 4000
					});
